...
namespace ChatBot
{
    public partial class Admin_AddTeacher : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                teacherid();
                    ...
                    {
                        string query1 = "insert into Teacher_details values(" + tid + "," + uid + ",'" + tname.Text + "','" + dept.Text + "','" + mob.Text + "','" + mail.Text + "','"+textBox1.Text+"',0,'"+deuserid.Text+"')";
        ...
        private void Admin_AddTeacher_Load(object sender, EventArgs e)
        {
            adddepartment();
        }
